      ...
      return (
        <div className="flex min-h-[60dvh] w-full flex-col items-center justify-center gap-3 px-6 pt-24 text-center">
          ...
          <button
            ...
            className="mt-2 inline-flex h-11 items-center justify-center rounded-[20px] bg-[--primary-1] px-5 text-sm font-semibold text-white transition-colors hover:bg-[#4338ca]"
          >
            Sayfayı Yenile
          </button>
        </div>
