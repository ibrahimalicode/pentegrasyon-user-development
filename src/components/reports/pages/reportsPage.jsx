      ...
      <div className="flex flex-col gap-4 py-4">
        ...
        <main className="w-full p-5 bg-[--white-1] rounded-xl border border-solid border-[--border-1] shadow-card">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex rounded-[20px] border border-solid border-[--border-1] p-0.5">
              {PERIODS.map((p) => (
                <button
                  key={p.id}
                  type="button"
                  ...
                  className={cn(
                    "rounded-[20px] px-4 py-1.5 text-xs font-medium transition-colors whitespace-nowrap",
                    periodType === p.id
