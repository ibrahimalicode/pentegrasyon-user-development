        ...
        <div className="mt-3 w-full max-w-sm rounded-lg border border-solid border-[--border-1] bg-[--white-1] px-3 py-2.5 text-left">
          <div className="flex items-start justify-between gap-2">
            ...
            <button
              ...
              className="shrink-0 rounded-[20px] border border-solid border-[--border-1] px-2.5 py-1 text-xs text-[--black-2] transition-colors hover:border-[--primary-1] hover:text-[--primary-1]"
            >
              Düzenle
            </button>
          </div>
