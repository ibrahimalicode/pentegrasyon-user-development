              ...
              <div className="w-full flex justify-between items-end gap-3">
                ...
                {card.active != null && (
                  <div className="flex gap-2 shrink-0">
                    <div className="flex items-center gap-1.5 rounded-[20px] bg-[--status-green] px-2.5 py-1">
                      <span className="text-xs font-semibold text-[--green-1]">
                        {card.active}
                      </span>
                      <span className="text-xs text-[--green-1]">Aktif</span>
                    </div>
                    <div className="flex items-center gap-1.5 rounded-[20px] bg-[--light-3] px-2.5 py-1">
