          ...
          <div className="flex items-center gap-1">
            ...
            {user?.fullName && (
              <Link
                to="/profile"
                title="Profili aç"
                className="max-md:hidden mr-1.5 flex items-center gap-2.5 rounded-[20px] border border-solid border-[--border-1] bg-[--white-1] py-1 pl-1 pr-3.5 hover:border-[--primary-1]/50 hover:bg-[--light-3] transition-colors"
              >
