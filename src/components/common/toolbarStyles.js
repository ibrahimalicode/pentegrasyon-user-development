...
export const TOOLBAR_STAT =
  "flex flex-col justify-center h-11 px-4 rounded-[20px] border border-[--border-1] bg-[--white-1] text-center whitespace-nowrap";
...
export const TOOLBAR_BTN =
  "inline-flex items-center justify-center gap-2 h-11 px-5 rounded-[20px] border border-[--border-1] bg-[--white-1] text-sm font-medium text-[--black-2] hover:bg-[--light-3] hover:border-[--primary-1] hover:text-[--primary-1] transition-colors whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--primary-1]/30 disabled:opacity-60 disabled:cursor-not-allowed";

// Primary call-to-action in a toolbar (e.g. "Lisans Ekle").
export const TOOLBAR_BTN_PRIMARY =
  "inline-flex items-center justify-center gap-2 h-11 px-5 rounded-[20px] bg-[--primary-1] text-sm font-semibold text-white hover:bg-[#4338ca] transition-colors whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--primary-1]/40";

// Bordered wrapper for an inline label + borderless select pair.
export const TOOLBAR_SELECT_GROUP =
  "flex items-center gap-2 h-11 pl-4 pr-1 rounded-[20px] border border-[--border-1] bg-[--white-1] whitespace-nowrap";
