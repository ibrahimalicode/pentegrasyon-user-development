  ...
  return (
    <div className={`flex flex-col mt-3 sm:mt-6 w-full relative ${className2}`}>
      ...
      <textarea
        ...
        className={`px-4 mt-1 sm:mt-2.5 text-base font-[300] rounded-md sm:rounded-md border border-solid border-[--border-1] text-[--gr-1] max-md:pr-5 w-full autofill:shadow-white autofill:outline-none ${className}`}
      />
      <div
