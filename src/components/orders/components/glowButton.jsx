const GlowButton = ({ text, onClick }) => {
  const buttonAnimations = {
    base: "w-24 py-2 px-2 rounded-lg border disabled:py-2.5 disabled:cursor-not-allowed relative overflow-hidden bg-gradient-to-r from-green-500 to-green-600",
